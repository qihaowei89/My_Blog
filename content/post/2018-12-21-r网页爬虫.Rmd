...
# 通过Xpath获取选项位置
web_elem_cite <- remDr$findElement(using = "xpath","/html/body/app-root/app-search-result-page/div/div[2]/div/app-search-result/div/div[2]/div[2]/a[4]")

# 模拟鼠标单击
web_elem_cite$clickElement()

web_cite <- remDr$findElement(using = "xpath",　"/html/body/app-root/app-search-result-page/div/div[2]/div/app-search-result/div[2]/div[2]/div/div[2]/div[2]")

# 获取需要提取的文本信息
# pubmed <- webRef$getElementAttribute("outerHTML")[[1]]
Cite <- web_cite$getElementText()[[1]]
