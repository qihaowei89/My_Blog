...
rnacocktail Docker镜像[下载地址](https://hub.docker.com/r/marghoob/rnacocktail/)   
Docker镜像制作的Dockerfile[下载地址](https://github.com/bioinform/rnacocktail/blob/master/docker/Dockerfile)
...
|R with [DESeq2](https://www.bioconductor.org/packages/devel/bioc/html/DESeq2.html), [readr](https://github.com/hadley/readr), and [tximport](https://github.com/mikelove/tximport),rjson, libraries|3.3.2|diff, editing
...
|[IDP](https://www.healthcare.uiowa.edu/labs/au/IDP/)|0.1.9|long_reconstruct
|[IDP-fusion](https://www.healthcare.uiowa.edu/labs/au/IDP-fusion/)|1.1.1|long_fusion
...
|[FusionCatcher](https://github.com/ndaniel/fusioncatcher)[fusioncatcher download](https://sourceforge.net/projects/fusioncatcher/files/data/)|0.99.5a beta|fusion
